...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/api/auth/login/admin', {
        email,
        password
      });
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 px-3 py-2.5 border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-slate-50/50 transition-colors"
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 px-3 py-2.5 border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-slate-50/50 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
